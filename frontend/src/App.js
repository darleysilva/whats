    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#1075F0" },
                textPrimary: mode === "light" ? "#1075F0" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#1075F0" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#1075F0" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #1075F0, #42B8FB, #19A0F6)" : "#666",
